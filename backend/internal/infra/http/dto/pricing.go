...
type PricingRequest struct {
	...
	ChannelOptions    domain.ChannelOptions `json:"channel_options"`
	ManualCosts       []domain.ManualCost   `json:"manual_costs"`
	...
	LogisticCost      *domain.VariableCost  `json:"logistic_cost"`
	Mode              domain.PricingMode    `json:"mode"`
}

func (r PricingRequest) ToDomain() domain.PricingInput {
	taxBPS := int64(400)
	if r.TaxBPS != nil {
		taxBPS = *r.TaxBPS
	}
	return domain.PricingInput{
